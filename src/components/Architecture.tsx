  ...
  const architectureComponents = [
    {
      icon: Database,
      title: 'Data Pipeline',
      description: 'Advanced feature engineering with microstructure analysis',
      details: [
        'Order flow imbalance features',
        'Real-time L2 book depth',
        'Kyle\'s Lambda & Amihud liquidity',
    ...
    },
    {
      icon: Cpu,
      title: 'ML Core',
      description: 'Regime-aware ensemble with dynamic weighting',
      details: [
    ...
    },
    {
      icon: Network,
      title: 'Risk Engine',
      description: 'Sophisticated capital protection and allocation',
      details: [
        'Adaptive Kelly position sizing',
        'Pair correlation management',
        'ATR-based trailing stop losses',
        'Multi-level profit target logic',
      ],
    },
    {
      icon: Cloud,
      title: 'Execution Layer',
      description: 'Optimized execution with smart order routing',
      details: [
        'Slippage estimation models',
        'Order flow optimization',
        'Post-only maker fee capture',
        'Latency-minimized routing',
      ],
    },
  ];
